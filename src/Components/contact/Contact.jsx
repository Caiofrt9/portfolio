    ...
    <div className="container contact__container">
      <div className="contact__options">
       <article className="contact__option">
         ...
         <a href="mailto:silvacaio295@gmail.com" target='_blank' rel="noreferrer">Send a message</a>
       </article>
       ...
       <article className="contact__option">
         ...
         <h4>WhatsApp</h4>
         <h5>silvacaio295@gmail.com</h5>
         <a href="https://api.whatsapp.com/send?phone=+559499033173" target='_blank' rel="noreferrer">Send a message</a>
       </article>
